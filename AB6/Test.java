...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nTest7 - TreeMap:");
        IntVarConstMap treeValues = new IntVarConstTreeMap();
        treeValues.put(x, new IntConst(3));
        treeValues.put(y, five);
        treeValues.put(z, new IntConst(-2));
        testIdentity(treeValues.containsKey(x), true);
        testIdentity(treeValues.containsKey(y), true);
        testIdentity(treeValues.containsKey(z), true);
        testIdentity(treeValues.size(), 3);
        testIdentity(treeValues.get(y), five);
        testIdentity(treeValues.remove(y), five);
        testIdentity(treeValues.size(), 2);
        testIdentity(treeValues.remove(y), null);
        testIdentity(treeValues.size(), 2);
